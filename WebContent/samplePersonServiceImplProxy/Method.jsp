...
<LI><A HREF="Input.jsp?method=15" TARGET="inputs"> getPerson(int)</A></LI>
<LI><A HREF="Input.jsp?method=26" TARGET="inputs"> deletePerson(int)</A></LI>
<LI><A HREF="Input.jsp?method=31" TARGET="inputs"> addPerson(com.journaldev.jaxws.beans.Person)</A></LI>
